...
class NotDancingBehavior : public IDanceBehavior
{
public:
	void Dance() override {}
};
...
public:
	DecoyDuck()
		: Duck(make_unique<FlyNoWay>(), make_unique<MuteQuackBehavior>(), make_unique<NotDancingBehavior>())
	{
	}
	void Display() const override
	{
...
public:
	RubberDuck()
		: Duck(make_unique<FlyNoWay>(), make_unique<SqueakBehavior>(), make_unique<NotDancingBehavior>())
	{
	}
	void Display() const override
	{
...
public:
	ModelDuck()
		: Duck(make_unique<FlyNoWay>(), make_unique<QuackBehavior>(), make_unique<NotDancingBehavior>())
	{
	}
	void Display() const override
	{
